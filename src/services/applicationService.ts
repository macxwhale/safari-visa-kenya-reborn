...
export const submitApplication = async (form: ApplicationFormState): Promise<{ id: string }> => {
  ...
  console.log('Form data being submitted:', cleanForm);
  ...
  const { data, error } = await safeAsync(async () => {
    const applicationData = {
      ...
      date_of_birth: cleanForm.dateOfBirth || null,
      place_of_birth: cleanForm.placeOfBirth,
      passport_issue_date: cleanForm.passportIssueDate || null,
      passport_expiry_date: cleanForm.passportExpiryDate || null,
      travel_from: cleanForm.travelFrom,
      entry_date: cleanForm.entryDate || null,
      exit_date: cleanForm.exitDate || null,
      ...
      accommodation_check_in_date: cleanForm.accommodationCheckInDate || null,
      accommodation_check_out_date: cleanForm.accommodationCheckOutDate || null,
